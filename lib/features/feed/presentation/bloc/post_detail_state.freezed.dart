...
mixin _$PostDetailState {
 ...
 Post get post; bool get isLiked; List<Comment> get comments; bool get sending; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,post,isLiked,const DeepCollectionEquality().hash(comments),sending,error);

@override
String toString() {
  return 'PostDetailState(post: $post, isLiked: $isLiked, comments: $comments, sending: $sending, error: $error)';
}
...
@useResult
$Res call({
 Post post, bool isLiked, List<Comment> comments, bool sending, String? error
});
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? post = null,Object? isLiked = null,Object? comments = null,Object? sending = null,Object? error = freezed,}) {
  return _then(_self.copyWith(
post: null == post ? _self.post : post // ignore: cast_nullable_to_non_nullable
as Post,isLiked: null == isLiked ? _self.isLiked : isLiked // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Post post,  bool isLiked,  List<Comment> comments,  bool sending,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.post,_that.isLiked,_that.comments,_that.sending,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Post post,  bool isLiked,  List<Comment> comments,  bool sending,  String? error)  $default,) {final _that = this;
switch (_that) {
case _PostDetailState():
return $default(_that.post,_that.isLiked,_that.comments,_that.sending,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Post post,  bool isLiked,  List<Comment> comments,  bool sending,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.post,_that.isLiked,_that.comments,_that.sending,_that.error);case _:
  return null;
...
class _PostDetailState implements PostDetailState {
  const _PostDetailState({required this.post, this.isLiked = false, final  List<Comment> comments = const <Comment>[], this.sending = false, this.error}): _comments = comments;
...
@override
int get hashCode => Object.hash(runtimeType,post,isLiked,const DeepCollectionEquality().hash(_comments),sending,error);
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? post = null,Object? isLiked = null,Object? comments = null,Object? sending = null,Object? error = freezed,}) {

...
mixin _$HomeData {
 ...
 String get welcomeMessage; DateTime get lastUpdated;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeData&&(identical(other.welcomeMessage, welcomeMessage) || other.welcomeMessage == welcomeMessage)&&(identical(other.lastUpdated, lastUpdated) || other.lastUpdated == lastUpdated));
}
...
@override
String toString() {
  return 'HomeData(welcomeMessage: $welcomeMessage, lastUpdated: $lastUpdated)';
}
...
@useResult
$Res call({
 String welcomeMessage, DateTime lastUpdated
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String welcomeMessage,  DateTime lastUpdated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HomeData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String welcomeMessage,  DateTime lastUpdated)  $default,) {final _that = this;
switch (_that) {
case _HomeData():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String welcomeMessage,  DateTime lastUpdated)?  $default,) {final _that = this;
switch (_that) {
case _HomeData() when $default != null:
return $default(_that.welcomeMessage,_that.lastUpdated);case _:
  return null;
...
class _HomeData implements HomeData {
  const _HomeData({required this.welcomeMessage, required this.lastUpdated});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HomeData&&(identical(other.welcomeMessage, welcomeMessage) || other.welcomeMessage == welcomeMessage)&&(identical(other.lastUpdated, lastUpdated) || other.lastUpdated == lastUpdated));
}

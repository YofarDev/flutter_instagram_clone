...
mixin _$PostDetailState {
 ...
 Post? get post; PostDetailStatus get status; bool get isLiked; bool get isSaved; List<Comment> get comments; bool get sending; String? get error;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostDetailState&&(identical(other.post, post) || other.post == post)&&(identical(other.status, status) || other.status == status)&&(identical(other.isLiked, isLiked) || other.isLiked == isLiked)&&(identical(other.isSaved, isSaved) || other.isSaved == isSaved)&&const DeepCollectionEquality().equals(other.comments, comments)&&(identical(other.sending, sending) || other.sending == sending)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,post,status,isLiked,isSaved,const DeepCollectionEquality().hash(comments),sending,error);

@override
String toString() {
  return 'PostDetailState(post: $post, status: $status, isLiked: $isLiked, isSaved: $isSaved, comments: $comments, sending: $sending, error: $error)';
}
...
@useResult
$Res call({
 Post? post, PostDetailStatus status, bool isLiked, bool isSaved, List<Comment> comments, bool sending, String? error
});
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? post = freezed,Object? status = null,Object? isLiked = null,Object? isSaved = null,Object? comments = null,Object? sending = null,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Post? post,  PostDetailStatus status,  bool isLiked,  bool isSaved,  List<Comment> comments,  bool sending,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.post,_that.status,_that.isLiked,_that.isSaved,_that.comments,_that.sending,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Post? post,  PostDetailStatus status,  bool isLiked,  bool isSaved,  List<Comment> comments,  bool sending,  String? error)  $default,) {final _that = this;
switch (_that) {
case _PostDetailState():
return $default(_that.post,_that.status,_that.isLiked,_that.isSaved,_that.comments,_that.sending,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Post? post,  PostDetailStatus status,  bool isLiked,  bool isSaved,  List<Comment> comments,  bool sending,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _PostDetailState() when $default != null:
return $default(_that.post,_that.status,_that.isLiked,_that.isSaved,_that.comments,_that.sending,_that.error);case _:
  return null;
...
class _PostDetailState implements PostDetailState {
  const _PostDetailState({this.post, this.status = PostDetailStatus.loading, this.isLiked = false, this.isSaved = false, final  List<Comment> comments = const <Comment>[], this.sending = false, this.error}): _comments = comments;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PostDetailState&&(identical(other.post, post) || other.post == post)&&(identical(other.status, status) || other.status == status)&&(identical(other.isLiked, isLiked) || other.isLiked == isLiked)&&(identical(other.isSaved, isSaved) || other.isSaved == isSaved)&&const DeepCollectionEquality().equals(other._comments, _comments)&&(identical(other.sending, sending) || other.sending == sending)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,post,status,isLiked,isSaved,const DeepCollectionEquality().hash(_comments),sending,error);
...
/// Create a copy of PostDetailState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? post = freezed,Object? status = null,Object? isLiked = null,Object? isSaved = null,Object? comments = null,Object? sending = null,Object? error = freezed,}) {
